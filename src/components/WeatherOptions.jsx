...
export const WeatherOptions = () => {
    ...
    return (
        <article className="bg-[#100E1D] mx-auto min-h-lvh min-w-[375px] tablet:grow tablet:min-w-[810px]  p-14" >
            <section className='max-w-[706px] container mx-auto text-[18px] pb-2 font-semibold leading-[21.13px] flex flex-row justify-end gap-4'>
                <button className={`${units === 'metric'? 'text-[#110E3C] bg-[#E7E7EB]' : 'bg-[#6E707A]'}  w-[40px] h-[40px] rounded-full cursor-pointer hover:bg-[#55565d] shadow-[#00000040]`} value='metric' onClick={handleChangeDegrees}>
                    °C
                </button>
                <button className={`${units === 'imperial'? 'text-[#110E3C] bg-[#E7E7EB]' : 'bg-[#6E707A]'}  w-[40px] h-[40px] rounded-full cursor-pointer hover:bg-[#55565d] shadow-[#00000040]`} value='imperial' onClick={handleChangeDegrees}>
                    °F
                </button>
            </section>
            <section className='container mx-auto py-6 max-w-[706px]'>
            ...
            <section className='container mx-auto max-w-[706px]'>
                ...
                <ul className='grid grid-cols-[repeat(auto-fill,328px)] gap-10 justify-center'>
                    <HightlightsCard
                    title={'Wind status'}

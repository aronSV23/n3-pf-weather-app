    ...
    return (
        <aside className="bg-[#1E213A] flex flex-col  justify-around grow tablet:shrink min-h-lvh min-w-[375px] tablet:max-w-[460px] font-Raleway relative">
            ...
            <div className='w-full text-center font-medium'>
                <h2 className=' text-[144px] text-white leading-[169.06px] tablet:text-[132px]'>{data.today.temperature}<span className='text-[#A09FB1] text-[48px] leading-[56.35px]'>{data.today.temperatureUnits}</span> </h2>
            </div>
